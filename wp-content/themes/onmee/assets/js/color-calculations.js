 ...
 * @return {Object} - this
 */
function _onmeeColor( backgroundColor, accentHue ) {
 ...
 * @return {Object} - this
 */
_onmeeColor.prototype.setAccentColorsArray = function() {
	var self = this,
		minSaturation = 65,
		maxSaturation = 100,
		minLightness = 30,
 ...
 */
_onmeeColor.prototype.getTextColor = function() {
 ...
 * @return {Color} - Returns a Color object.
 */
_onmeeColor.prototype.getAccentColor = function() {
	var fallback;
...
/**
 * Return a new instance of the _onmeeColor object.
 *
 * @since Onmee Onmee 1.0
 *
 * @param {string} backgroundColor - The background color.
 ...
 * @return {Object} - this
 */
function onmeeColor( backgroundColor, accentHue ) {// jshint ignore:line
	var color = new _onmeeColor( backgroundColor, accentHue );
